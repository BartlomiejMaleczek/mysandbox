...
export default class Calendar extends ServiceAbstract {
    ...
    constructor() {
        ...
        this.endRangeWeekDate = this.utils.jsUtils.addDays(this.startRangeWeekDate, this.nbrOfColsToGenerate);
    ...
    handlePreviousWeek() {
        ...
        this.isLoading = true;
        setTimeout(function () {
            this.endRangeWeekDate = this.utils.jsUtils.addDays(this.endRangeWeekDate, -this.nbrOfColsToGenerate);
            this.startRangeWeekDate = this.utils.jsUtils.addDays(this.startRangeWeekDate, -this.nbrOfColsToGenerate);
            this.generateColumns();
    ...
    get isPrevWeekButtonDisabled() {
        if (this && this.utils && this.utils.jsUtils) {
            return (this.utils.jsUtils.formatDateYYYYMMDD(this.startRangeWeekDate) == this.utils.jsUtils.formatDateYYYYMMDD(new Date()));
        } else {
            return false;
        }
    }
